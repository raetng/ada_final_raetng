"""STAGE 2 HistGradientBoostingRegressor on log(SPP) | SPP > $100 (multi-hub).

Multi-hub analog of stage2_train_hgb.py. Same 2x2 grid, timestamp-grouped
splitter.
"""
...
RESULTS_PATH = PROJECT_ROOT / "outputs" / "stage2" / "multihub" / "hgb_results.json"
PRED_PATH = PROJECT_ROOT / "outputs" / "stage2" / "multihub" / "hgb_best_predictions.npz"
IMP_PLOT_PATH = PROJECT_ROOT / "outputs" / "stage2" / "multihub" / "hgb_feature_importance.png"
MODEL_PATH = PROJECT_ROOT / "models" / "stage2_hgb_best_multihub.pkl"
...
def main():
    print("=" * 70)
    print("STAGE 2: HIST GRADIENT BOOSTING (MULTI-HUB)")
    print("=" * 70)
    ...
    imp_df = plot_perm_importance(
        ...
        f"Stage 2 HGB {best_name} (multi-hub) — permutation importance"
    )
